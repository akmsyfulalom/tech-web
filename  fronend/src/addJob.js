...
const AddJob = () => {
  ...
  const [category, setCategory] = useState('Acounting&Finance');
          ...
          {jobDetails &&
            <div className='container d-flex justify-content-center' style={{ width: '75px' }}>
              <div className='row d-flex justify-content-center'>
                ...
                <div className="col-5 py-5" style={{ paddingLeft: '5px' }}>
                ...
                <div className="col-5 py-5 d-flex justify-content-end" style={{ paddingRight: '5px' }}>
                  <button
                    type='submit'
