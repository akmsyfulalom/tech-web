...
function Cart() {
    ...
    return (
        <section className='cart-page m-3'>
            <button className="btn btn-primary mt-2" onClick={() => navigate('/user/productlist')}>Back</button>
            <div className='text-center text-light bg-secondary mb-2 mt-2'>
                    ...
                    <div className='col-md-4'>
                        <div className="card">
                            <div className="card-body">
                                ...
                                <Link to="/user/Cheakout" state={{ cartItems: cartItems, totalPrice: totalPrice }} className="btn btn-primary">Checkout</Link>
                            </div>
                        </div>
